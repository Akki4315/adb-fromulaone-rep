...
qualifying_df = spark.read.parquet("/mnt/processed/qualifying_tbl/").withColumnRenamed("q1","qualifying1").withColumnRenamed("q2","qualifying2").withColumnRenamed("q3","qualifying3").filter(f"file_date = '{file_dt}'")
