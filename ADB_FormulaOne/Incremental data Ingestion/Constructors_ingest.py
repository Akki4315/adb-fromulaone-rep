...
df = spark.read.json(f"/mnt/formulaoneadb/raw/{file_dt}/{source_name}.json", input_schema)
df.display()
...
# MAGIC %sql
# MAGIC select constructor_id, count(1) from f1_processed.constructors_tbl
