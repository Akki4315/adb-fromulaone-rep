...
df = spark.read.json(f"/mnt/formulaoneadb/raw/{file_dt}/{source_name}.json", input_schema, multiLine=True)
...
# MAGIC %sql
# MAGIC select race_id, count(1) from f1_processed.pitstops_tbl
