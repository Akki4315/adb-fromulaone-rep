...
pitstop_df = spark.read.parquet("/mnt/formulaoneadb/mng_tbl/processed/pitstops_tbl/").withColumnRenamed("stop","pits")
...
result_df = spark.read.parquet("/mnt/formulaoneadb/mng_tbl/processed/results_tbl/").withColumnRenamed("time", "race_time").withColumnRenamed("race_id","result_race_id").filter(f"file_date = '{file_dt}'").withColumnRenamed("file_date", "result_file_date")
